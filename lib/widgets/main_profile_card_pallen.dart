...
/// MainProfileCardPallen — the individual 9:16 card for Pallen, Prince Dunhill
/// shown in the main dashboard carousel.
///
/// This is a separate file so Pallen's card can be independently styled,
/// updated, or have its own unique design without affecting the other cards.
///
/// Tapping opens ProfileDetailPallen at /profile-pallen.
...
class _MainProfileCardPallenState extends State<MainProfileCardPallen> {
  ...
  // Edit these fields to update Pallen's card on the main dashboard
  ...
  static const String _coverPhoto = 'assets/images/cover1.jpg';
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: GestureDetector(
        onTap: () => context.push('/profile-pallen'),
        child: AnimatedContainer(
          duration: const Duration(milliseconds: 200),
          // ✅ 9:16 aspect ratio preserved
          child: AspectRatio(
            aspectRatio: 9 / 16,
            child: ClipRRect(
